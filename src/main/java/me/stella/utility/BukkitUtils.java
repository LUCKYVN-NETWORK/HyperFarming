...
public class BukkitUtils {
    ...
    public static void initCropMap() {
        ...
        idItemMap.put("POTATO", new ItemStack(Objects.requireNonNull(BukkitUtils.returnOneOf("POTATO_ITEM", "POTATO"))));
        idItemMap.put("CARROT", new ItemStack(Objects.requireNonNull(BukkitUtils.returnOneOf("CARROT_ITEM", "CARROT"))));
        idItemMap.put("BEETROOT", new ItemStack(Material.BEETROOT));
        idItemMap.put("MELON", new ItemStack(Objects.requireNonNull(BukkitUtils.returnOneOf("MELON_SLICE", "MELON"))));
        idItemMap.put("MELON_BLOCK", new ItemStack(Objects.requireNonNull(BukkitUtils.returnOneOf("MELON_BLOCK", "MELON"))));
